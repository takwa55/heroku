...
@endsection
@section('content')
    <div class="card"style="background: linear-gradient(90deg, #4b6cb7 0%, #182848 100%);>
        <div class="card-body"  style="background-color: #35465c; border-radius:7px;">
            <h5 style="color: white; text-align:center; font:bolder" >Wilaya statistique</h5>
        </div>
    </div>
    <div class="card-body"style="background: linear-gradient(90deg, #4b6cb7 0%, #182848 100%);>
        <div class="col-xl-12">
